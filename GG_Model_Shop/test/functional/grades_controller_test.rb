...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { grade_type: @grade.grade_type, gundam_model_id: @grade.gundam_model_id, id: @grade.id }
    end
  ...
  test "should update grade" do
    put :update, id: @grade, grade: { grade_type: @grade.grade_type, gundam_model_id: @grade.gundam_model_id, id: @grade.id }
    assert_redirected_to grade_path(assigns(:grade))
  end
